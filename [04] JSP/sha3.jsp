<%!
    ...
    public final void sha3_224_init() {
        sha3_init(KECCAK_SHA3_224, SHA3_SHAKE_NONE);
    };

    public final void sha3_256_init() {
        sha3_init(KECCAK_SHA3_256, SHA3_SHAKE_NONE);
    };

    public final void sha3_384_init() {
        sha3_init(KECCAK_SHA3_384, SHA3_SHAKE_NONE);
    };

    public final void sha3_512_init() {
        sha3_init(KECCAK_SHA3_512, SHA3_SHAKE_NONE);
    };

    public final void shake128_init() {
        sha3_init(KECCAK_SHAKE128, SHA3_SHAKE_USE);
    };

    public final void shake256_init() {
        sha3_init(KECCAK_SHAKE256, SHA3_SHAKE_USE);
    };
